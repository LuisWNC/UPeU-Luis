...
public class Mine extends JFrame implements ActionListener, MouseListener{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if (b[row][column].getBackground() == Color.red){
            return;
        }else if (mines[row+1][column+1] == 1){
                JOptionPane.showMessageDialog(temporaryLostComponent, "Ha perdido\nPiso una mina");
                System.exit(0);
        } else {
    ...
    public void checkifend(){
        ...
        if (check == nomines){
            ...
            Component temporaryLostComponent = null;
            JOptionPane.showMessageDialog(temporaryLostComponent, "Felicidades usted ha ganado: "+(int)((endtime-starttime)/1000000000)+" Segundos!");
        }
    }
